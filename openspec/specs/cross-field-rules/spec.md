...
Bind cross-field semantic rules to declared paths, validate backtick references, restrict compiled state to those paths, and type-check the `crossField` contract.

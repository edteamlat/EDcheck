...
Define the offline fixture corpus, payload snapshots, skippable real-Jev eval runner, miss bands, Score-level assertions, and baseline-derived default thresholds.

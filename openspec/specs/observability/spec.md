...
Register optional parse hooks (`onRequest`, `onResponse`, `onError`) that observe provider traffic without changing outcomes, delaying the parse, or writing to stdout, stderr, or console.
